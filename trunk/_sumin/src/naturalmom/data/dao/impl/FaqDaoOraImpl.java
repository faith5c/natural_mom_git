...
public class FaqDaoOraImpl extends NamedParameterJdbcDaoSupport implements IFaqDao {
	private final String SQL_SELECT_FAQ_LIST = "SELECT faq_no, faq_title FROM tb_faq WHERE board_id=3 AND faq_del_check=0 ORDER BY faq_no ASC";
	...
	public List<FaqVo> getAllFaq() throws DataAccessException {
		return this.getJdbcTemplate().query(SQL_SELECT_FAQ_LIST, new BeanPropertyRowMapper<FaqVo>(FaqVo.class));
	}
