...
FROM "tb_product" p JOIN "tb_product_n_cart" c 
...
SELECT "product_no", "mem_id", "buy_num" FROM "tb_product_n_cart" WHERE "product_no"=10000 and "mem_id"='soomin';
...
INSERT INTO "tb_product_n_cart" ("product_no", "mem_id", "buy_num") values (10000, 'soomin', 1);

--------------------------------------------------------------------------------

-- 장바구니 상품 삭제
-- 상품번호를 받아오고 회원아이디 확인해서 해당하는 관심상품 삭제함, 
DELETE FROM "tb_product_n_cart" WHERE "product_no"=10000 AND "mem_id"='soomin';

--------------------------------------------------------------------------------

-- 장바구니에서 상품당구매개수 수정함
UPDATE "tb_product_n_cart" SET "buy_num"=3 WHERE "product_no"=10000 AND "mem_id"='soomin';
