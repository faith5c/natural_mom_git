...
<body>
	...
	<table cellspacing="2">
		...
		<tr>
			<th>작성자</th>
			<td><input type="text" maxlength="15" style="width:30%" value="hook4u" readonly="readonly"/></td>
		</tr>
		<tr>
			<th>비밀번호</th>
			<td><input type="password" maxlength="15" style="width:30%"/></td>
		</tr>
		<tr>
			<th>내용</th>
			<td>
			<textarea id="qna_area" name="text" cols="80" rows="14"></textarea>
			</td>
		</tr>
		<tr>
			<td colspan="2">
