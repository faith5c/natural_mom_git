package com.nmom.soap.data.model.product;

public class VProduct_ManageVo
{
	// Î©§Î≤Ñ Î≥?àò
	int product_no;
	String category_nm;
	...
	// ?ùÏÑ±??
	public VProduct_ManageVo() {}
	
	public VProduct_ManageVo(int product_no, String category_nm,
