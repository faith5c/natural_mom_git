	...
	<div id="container">
		...
		<section>
			...
			<c:forEach var="pl" items="${product_list}">
				<div>
				<a href="/soap/product/detail.nm?pdno=${pl.product_no}"><img src="<%= request.getSession().getServletContext().getRealPath("/") +  "resources/product_images/" %>${pl.represent_img}" alt="${pl.product_name}"></a>
