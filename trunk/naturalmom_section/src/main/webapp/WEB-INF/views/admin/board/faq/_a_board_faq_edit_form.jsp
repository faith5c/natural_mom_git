...
<body>
	...
	<table cellspacing="2">
		...
		<tr>
			<th>내용</th>
			<td>
			<textarea id="faq_area" style="width:100%; resize:none;" rows="14">${fvo.faq_content}</textarea>
			<input type="hidden" name="content" id="faq_content" value="content"/>
			<input type="hidden" name="fe_no" value="${fvo.faq_no}"/>
			</td>
		</tr>
		<tr>
			<td colspan="2">
				<input type=submit value="확인" onclick = "editFaq()">
