...
SELECT o.ORDER_DATE FROM tb_order o WHERE to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04';

SELECT (SELECT COUNT(o.order_no) FROM tb_order o WHERE o.order_date = '2016-04-04') AS order_no, 
(SELECT DISTINCT po.product_no FROM tb_product_n_order po, tb_order o WHERE po.order_no = o.order_no 
AND o.order_date = '2016-04-04' ) AS product_no, 
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '2016-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND o.order_date = '2016-04-04')*3000 ) AS sale_sum,
(SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no 
AND po.process_cd = 21 AND o.order_date = '2016-04-04')*3000 AS delivery_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '2016-04-04') AS sale_total_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND o.order_date = '2016-04-04') AS refund_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND o.order_date = '2016-04-04') - (SELECT COUNT(o.charge) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 32 AND o.order_date = '2016-04-04')*3000) AS refund_total_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '2016-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND o.order_date = '2016-04-04')*3000) AS net_sale
FROM DUAL;
--WHERE o.order_date >= '2016-03-30' AND o.order_date <= SYSDATE;

SELECT (SELECT COUNT(order_no) FROM tb_order o WHERE o.order_date = '16-04-04' ) AS order_no, 
(SELECT DISTINCT po.product_no FROM tb_product_n_order po, tb_order o WHERE po.order_no = o.order_no 
AND o.order_date = '16-04-04' ) AS product_no, 
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '16-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND o.order_date = '16-04-04')*3000 ) AS sale_sum,
(SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no 
AND po.process_cd = 21 AND o.order_date = '16-04-04')*3000 AS delivery_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '16-04-04') AS sale_total_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND o.order_date = '16-04-04') AS refund_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND o.order_date = '16-04-04') - (SELECT COUNT(o.charge) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 32 AND o.order_date = '16-04-04')*3000) AS refund_total_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND o.order_date = '16-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND o.order_date = '16-04-04')*3000) AS net_sale
FROM DUAL;
...
SELECT COUNT(o.order_no ) FROM tb_order o WHERE to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04';

SELECT COUNT(DISTINCT po.product_no) FROM tb_product_n_order po, tb_order o WHERE po.order_no = o.order_no 
AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04' ;

SELECT (SELECT COUNT(o.order_no ) FROM tb_order o WHERE to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') AS order_no, 
(SELECT COUNT(DISTINCT po.product_no) FROM tb_product_n_order po, tb_order o WHERE po.order_no = o.order_no 
AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') AS product_no, 
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04')*3000 ) AS sale_sum,
(SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no 
AND po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04')*3000 AS delivery_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') AS sale_total_sum,
(SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') AS refund_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 32 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') - (SELECT COUNT(o.charge) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 32 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04')*3000) AS refund_total_sum,
((SELECT SUM(o.charge) FROM tb_order o, tb_product_n_order po WHERE o.order_no = po.order_no AND 
po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04') - (SELECT COUNT(o.order_no) FROM tb_order o, tb_product_n_order po WHERE 
o.order_no = po.order_no AND po.process_cd = 21 AND to_char(o.order_date, 'YYYY-MM-DD') = '2016-04-04')*3000) AS net_sale
FROM DUAL;
...
--<<공지사항-회원>>--
--- 게시글보기(전체 리스트)
SELECT notice_no, ntc_title, (SELECT COUNT(nr.notice_re_no) FROM tb_notice_re nr, tb_notice n WHERE nr.notice_no = n.notice_no)AS ntc_re_no, ntc_write_day, ntc_hits, mem_id FROM tb_notice WHERE ntc_del_check = 0
ORDER BY notice_no DESC;

n.notice_no,  ntc_title, ntc_re_no, ntc_content, ntc_write_day, ntc_hits, n.mem_id

CREATE OR REPLACE VIEW v_notice AS
SELECT n.notice_no,  ntc_title, COUNT(notice_re_no) AS ntc_re_no, ntc_content, ntc_write_day, ntc_content, ntc_hits, n.mem_id
...
SELECT notice_no, ntc_title, ntc_re_no, ntc_write_day, ntc_hits, mem_id 
FROM v_notice 
WHERE ntc_title LIKE '%휴%' AND ROWNUM >= 1 AND ROWNUM <= 10;
...
SELECT notice_no, ntc_title, ntc_re_no, ntc_write_day, ntc_hits, mem_id 
FROM v_notice 
WHERE ntc_content LIKE '%비누%' AND ROWNUM >= 1 AND ROWNUM <= 5 ;
...
SELECT notice_no, ntc_title, ntc_re_no, ntc_write_day, ntc_hits, mem_id 
FROM v_notice 
WHERE mem_id LIKE '%admin01%' AND ROWNUM >= 1 AND ROWNUM <= 5 ;
...
SELECT notice_no, ntc_title, ntc_re_no, ntc_write_day, ntc_hits, mem_id 
FROM v_notice 
WHERE (ntc_title LIKE '%비누%' OR  ntc_content LIKE '%비누%') AND ROWNUM >= 1 AND ROWNUM <= 5 ;
