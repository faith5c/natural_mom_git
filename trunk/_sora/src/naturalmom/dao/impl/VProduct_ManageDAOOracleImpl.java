...
import naturalmom.dao.IVProduct_ManageDAO;
import naturalmom.model.VProduct_Manage;

import org.springframework.jdbc.core.BeanPropertyRowMapper;
import org.springframework.jdbc.core.support.JdbcDaoSupport;

public class VProduct_ManageDAOOracleImpl extends JdbcDaoSupport implements IVProduct_ManageDAO 
{
	// 상품 번호 오름차순 정렬
	...
	public List<VProduct_Manage> selectAllProduct_by_product_no(boolean order) throws DataAccessException 
	{
		if(order)
			return getJdbcTemplate().query(SELECT_ALL_BY_PRODUCT_NO_ASC, 
					new BeanPropertyRowMapper<VProduct_Manage>(VProduct_Manage.class));
		else
