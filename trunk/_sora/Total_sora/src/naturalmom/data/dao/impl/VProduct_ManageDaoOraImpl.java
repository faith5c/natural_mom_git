...
{
	// 상품 개수 구하기
	private final String GET_COUNT_PRODUCT = "SELECT COUNT(product_no) FROM v_product_manage";
	// 상품 번호 오름차순 정렬
	...
	@Override
	public int getCountAllProduct() throws DataAccessException 
	{
		return getJdbcTemplate().queryForInt(GET_COUNT_PRODUCT);
	}
}
